        ...
        if (xmlhttp.readyState == XMLHttpRequest.DONE) {   // XMLHttpRequest.DONE == 4
           if (xmlhttp.status == 200) {
               ...
               for (var i=0; i < all_places.length; i++) {
                 ...
                 place.position = new google.maps.LatLng(place.x, place.y);
  ...
  return check;
      ...
      function initMap(features) {
        ...
        features.forEach(function(feature) {
            if (findGetParameter('filter') == null || feature.type.toLowerCase() == findGetParameter('filter')) {
              ...
              if ($(window).width()>992) {
                ...
                var gplay= '<a target="_blank" href="https://therealbitcoin.club/moveyourbch"><img class="batsch" src="'+baseUrl + 'img/google-play-badge'+badgeSize+'.png"></a>'
                var dir= '<a target="_blank" href="'+directions+'"><img class="batsch" src="'+baseUrl + 'img/google-maps-badge'+badgeSize+'.png"></a>'
                ...
                var discountText = ["10% discount on first BCH payment","20% discount on first BCH payment","Accepting Bitcoin payments soon","Trade Bitcoin here with 0.0% fee"];

                            var tagText = ["Bitcoin","Events","Trading","Organic","Vegetarian","Vegan","Healthy","Burger","Bocadillo","Muffin","Brownie","Cake","Cookie","Tiramisu","Pizza","Salad","Smoothie","Fruit","IceCream","Raw","Handbag","Cosmetic","Tattoo","Piercing","Souvenir","Hatha","Vinyasa","Massage","Upcycled","Coffee","NoGluten","Cocktails","Beer","Music","Projects","Electro","Rock","LiveDJ","Terrace","Seeds","Grinder","Papers","Advice","Calzone","Suppli","MakeUp","Gifts","Tapas","Copas","Piadina","Hierba","Granel","Fashion","Fair","Women","Drinks","TV","Retro","Color","BW","BTC","BCH","Online","Booking","HotDog","Fast","Kosher"];





                var tag0 = tagText[tags[0]];
                            var tag1 = tagText[tags[1]];
                                        var tag2 = tagText[tags[2]];
                                                    var tag3 = tagText[tags[3]];
                ...
                contentString += '<img onClick="imatsch();" width="' + imgWidth + '" alt="PLEASE USE CHROME BROWSER FOR IMAGE SUPPORT" src="'+photo+'.'+imageType+'">'
