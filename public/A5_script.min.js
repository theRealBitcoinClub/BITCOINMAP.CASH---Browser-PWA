...
function initMap(allPlaces) {
    ...
    allPlaces.forEach(function(currentMerchant) {
        ...
        var socialmedia = "<a target='_blank' href='https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fbmap.app%2F" + encodeURIComponent(currentMerchant.n) + "' target='_blank'><img class='socialicons' alt='Facebook' src='img/facebook.png'/></a>" + "<a target='_blank' href='https://twitter.com/share?url=https%3A%2F%bmap.app%2F" + encodeURIComponent(currentMerchant.n) + "&via=Coinector&text=Check%20this%20%23bitcoin%20place%20on%20%23Coinector%3A'><img class='socialicons' alt='Twitter' src='img/twitter.png'/></a><a href='https://bmap.app/" + encodeURIComponent(currentMerchant.n) + "' target='_blank'><img class='socialicons' alt='Coinector - CoinMap' src='coinector192x192.png' style='padding-top:7px;margin-right: 5px;'/></a>";
