        ...
        if (xmlhttp.readyState == XMLHttpRequest.DONE) { // XMLHttpRequest.DONE == 4
            if (xmlhttp.status == 200) {
              ...
              /*  var bmapid = getQueryVariable("bmapid");
                var isTest = getQueryVariable("isTest");
                ...
                for (var i = 0; i < all_places.length; i++) {
                   ...
                   /* if(isTest.includes('yes')) {
                        alert(place.p);
                    }*/

                   // log("placefgudfigh34uig4te32   BEFORE CONTINUE:     " + place);
/*
                    if (bmapid != null && bmapid != '' && !place.includes(bmapid))
                        continue;

                    if (log != null && log != '') {
                        log("placefgudfigh34uig4te32   AFTER CONTINUE PLACE:     " + place);
                        log("placefgudfigh34uig4te32   AFTER CONTINUE BMAPID:     " + bmapid);
                        log("placefgudfigh34uig4te32   AFTER CONTINUE isTest:     " + isTest);
                    }*/
