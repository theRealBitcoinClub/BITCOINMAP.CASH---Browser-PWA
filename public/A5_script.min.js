    ...
    var latLng = new google
       ...
       var ownPositionMarker = new google
        ...
        ownPositionMarker.addListener('click', function() {
            ...
            setTimeout(function(){ownPositionMarker.setMap(null);},8000);
        });
...
function initMap(allPlaces) {
    ...
    allPlaces.forEach(function(currentMerchant) {
        ...
        var socialmedia = "<a target='_blank' href='https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fcoincoffee.club%3Fid%3D" + currentMerchant.p + "' target='_blank'><img class='socialicons' alt='Facebook' src='bch-dash-btc/facebook-icon.png' /></a>"
                                 + "<a target='_blank' href='https://twitter.com/share?url=http%3A%2F%2Fcoincoffee.club%3Fid%3D" + currentMerchant.p + "&via=BarrioBitcoin&text=Check%20this%20%23bitcoin%20place%20on%20%23CoinCoffeeClub%3A'><img class='socialicons' alt='Twitter' src='bch-dash-btc/twitter2.png' /></a><a href='http://coincoffee.club?id=" + currentMerchant.p +"' target='_blank'><img class='socialicons' alt='Bitcoin Maps' src='bch-dash-btc/android-icon-192x192.png' style='padding:0px;margin-right: 5px;' /></a>";
...
function findGetParameter(parameterName) {
    ...
    //alert('p:' + parameterName + "r" + result);
    return result;
}
